...
RainyDay.prototype.prepareForm=function(){
    ...
    input3.type='button';
    input3.value='LOGIN';
    input3.addEventListener('click',changeForm2);
    input3.addEventListener('click',login);
    var input4=document.createElement('input');
    input4.id='signup';
    input4.type='button';
    input4.value='SIGNUP';
    input4.addEventListener('click',changeForm);
    input4.addEventListener('click',insert);
	...
	this.options.parentElement.appendChild(form);
	return form;
}
    
var changeForm2=function(){
	if(!formChanged) return;
      var father=document.getElementById('myForm');
      for(var i=0;i<4;i++){
    ...
    input2.type='password';
    input2.placeholder='Password';
    father.insertBefore(input2,father.firstChild);
    father.insertBefore(input1,father.firstChild);
    formChanged=false;
    isLogInForm=true;
    isSignUpForm=false;
}
...
var changeForm=function(){
    ...
    input3.placeholder='RepeatPassword';
    var input4=document.createElement('input');
    input4.id='name';
    input4.className='input';
    input4.placeholder='NickName';
    father.insertBefore(input4,father.firstChild);
    father.insertBefore(input3,father.firstChild);
    father.insertBefore(input2,father.firstChild);
    father.insertBefore(input1,father.firstChild);
    formChanged=true;
    isLogInForm=false;
...
var login=function(){
	...
	createXHR();    
    XHR.open("GET","login.php?id="+id+"&psw="+psw,true);
...
var stateChanged=function(){
    ...
    {    var temp=XHR.responseText.trim();
		...
		if(temp=='1') 
			window.location.href="http://120.24.42.137/liuyanY/";
		 else if(temp=='2') alert('Validation Failed!');
    }
}
var XHR2;
 var createXHR2=function(){              //首先我们得创建一个XMLHttpRequest对象
     if(window.ActiveXObject){//IE的低版本系类
